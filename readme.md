...
Add `"garmanio/shopify"` in your "require" object. With a blank Laravel install, it will look something like this:

For Laravel 5, use `"garmanio/shopify": "~3.0"`

####Add the Service Provider
In `app/config/app.php`, add `GarmanIO\Shopify\ShopifyServiceProvider` to the end of the `providers` array.
